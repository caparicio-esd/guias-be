...
urlpatterns = [
    ...
    path("chronograms/", GuiaChronogramListView.as_view(), name="chronogram_list"),
    path("chronograms/<int:pk>/", GuiaChronogramSingleView.as_view(), name="chronogram_single"),
    path("chronogramblocks/<int:pk>/", GuiaChronogramBlockView.as_view(), name="chronogramblock_single"),
    path("chronograms/<int:pk>/chronogramblocks/<int:block>/", GuiaChronogramBlockByChronogramSingleView.as_view(), name="chronogram_chronogramblock_single"),
    path("chronograms/<int:pk>/chronogramblocks/", GuiaChronogramBlockByChronogramListView.as_view(),
         name="chronogram_chronogramblock_list"),
